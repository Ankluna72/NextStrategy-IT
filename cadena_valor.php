...
<div class="container mt-4">
    <div class="module-container">
        <div class="module-header">
            <h2 class="module-title">6. CADENA DE VALOR</h2>
        </div>
        <div class="module-content">
            
            <div class="explanation-box p-4 mb-5">
                 <p><strong>La Cadena de Valor es una herramienta que permite a la empresa identificar aquellas actividades o fases que pueden aportarle un mayor valor añadido al producto final.</strong> Su objetivo es buscar fuentes de ventaja competitiva.</p>
                <p>Una cadena de valor genérica está constituida por tres elementos básicos: <strong>Actividades Primarias, Actividades de Apoyo y Margen</strong>. Cada eslabón de la cadena puede ser fuente de ventaja competitiva.</p>
                <hr>
                <h5>Actividades Primarias</h5>
                <p>Son aquellas que tienen que ver con el producto/servicio, su producción, logística, comercialización, etc. Incluyen: Logística de entrada, Operaciones, Logística de salida, Marketing y Ventas, y Servicios.</p>
                <h5>Actividades de Soporte</h5>
                <p>Apoyan a las actividades primarias. Incluyen: Infraestructura empresarial, Gestión de RRHH y Desarrollo tecnológico.</p>
                <h5>El Margen</h5>
            ...
            <h3 class="module-subtitle">Autodiagnóstico de la Cadena de Valor Interna</h3>
            ...
            <form action="cadena_valor.php" method="POST">
            ...
            <div class="d-flex justify-content-between mt-4">
                <a href="analisis_info.php" class="btn btn-nav">&laquo; Anterior: Info. Análisis</a>
